...
<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <section class="py-12 bg-black dark:bg-green-800">
                ...
                <div class="bg-green-600 dark:bg-green-700 overflow-hidden shadow-sm mb-2">
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="p-6 text-white">
                            ...
                            <p>Support toilet accessibility initiatives by sharing information about accessible toilets,
                                ratings, and reviews. Keep track of toilet locations, opening hours, and cleanliness status.
                            </p>
                            <p>The Jacks app was developed with the aim of improving toilet access and promoting better
                                sanitation practices. Our mission is to provide a user-friendly platform for both toilet
                                users and facility owners, making toilet-related information easily accessible to everyone.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-green-600 dark:bg-green-700 overflow-hidden shadow-sm mb-4">
                    <div class="p-6 text-white">
                        ...
                        <div class="mt-4">
                            ...
                            <p>Up to the 1970s there were sixty staffed public toilets in Dublin. Today there are less than
                ...
                <div class="bg-green-600 dark:bg-green-700 overflow-hidden shadow-sm mb-4">
                    <div class="p-6 text-white">
                        ...
                        <div class="mt-4">
                            ...
                            <p>Dublin city is often criticised for its lack of facilities.One of the biggest strains on the
                                city is the lack of public toilets. This was particularly made apparent during the Covid-19
                                pandemic.However with the city busier than ever the conversation is cropping up more and
                                more.</p>
                            <button class="bg-orange-500 hover:bg-orange-600 text-white font-semibold py-2 px-4 rounded">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex flex-wrap justify-between">
                    ...
                    <div class="w-full md:w-1/2 lg:w-1/4 bg-green-600 dark:bg-green-700 overflow-hidden shadow-sm mb-4">
                        ...
                        <div class="p-4 text-white">
                            <h3 class="text-lg font-semibold mb-2">‘Crazy’: Why would people object to public toilets in
                                Dublin city?</h3>
                            <p class="text-sm">First facility beside DCU opened last year but remaining five sites are still
                                unused</p>
                            <button class="bg-orange-500 hover:bg-orange-600 text-white font-semibold py-2 px-4 rounded">
                    ...
                    <div class="w-full md:w-1/2 lg:w-1/4 bg-green-600 dark:bg-green-700 overflow-hidden shadow-sm mb-4">
                        ...
                        <div class="p-4 text-white">
                            <h3 class="text-lg font-semibold mb-2">Campaigners call for more public toilets in Dublin city
                                centre</h3>
                    ...
                    <div class="w-full md:w-1/2 lg:w-1/4 bg-green-600 dark:bg-green-700 overflow-hidden shadow-sm mb-4">
                        ...
                        <div class="p-4 text-white">
                            <h3 class="text-lg font-semibold mb-2">Why lack of public toilets in Dublin City Centre is a
                                female issue.</h3>
                            <p class="text-sm">"Women lose hours of their lives waiting in queues for the toilet because of
