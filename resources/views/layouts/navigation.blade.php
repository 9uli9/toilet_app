<nav x-data="{ open: false }" class="bg-black border-b ">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <x-nav-link :href="route('user.toilets.create')" :active="request()->routeIs('toilets')" class="text-white ">
                    {{ __('Add A Toilet') }}
                </x-nav-link>
            </div>
            
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <x-nav-link :href="route('user.toilets.index')" :active="request()->routeIs('toilets')" class="text-white ">
                    {{ __('Toilets Near Me') }}
                </x-nav-link>
            </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white focus:outline-none transition ease-in-out duration-150">
                            ...
                            <img src="{{ asset('./images/profile.png') }}" alt="Profile Image" class="w-auto h-auto">
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-white   focus:outline-none focus:bg-red-100  transition duration-150 ease-in-out">
