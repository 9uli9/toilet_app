        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div class="bg-green-600 dark:bg-green-600 rounded-lg shadow-sm">
                    <div class="p-6">
                        <h2 class="text-2xl font-semibold mb-4">Edit A Review</h2>
                        ...
                        <div class="py-6">
                            <div class="max-w-lg mx-auto sm:px-6 lg:px-8">
                                <div class="my-4 p-4 bg-white border border-green-300 shadow-sm sm:rounded-lg">
                                    ...
                                    <form enctype="multipart/form-data" action="{{ route('admin.reviews.store') }}" method="POST"
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="toilet_id" id="toilet_id" class="border border-gray-300 p-2 w-full">
                                        ...
                                        @foreach ($toilets as $toilet)
                                            <option value="{{ $toilet->id }}" {{ old('toilet_id', $review->toilet_id) == $toilet->id ? 'selected' : '' }}>{{ $toilet->id }} {{ $toilet->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
