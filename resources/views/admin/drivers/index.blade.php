...
@section('header')
        <h2 class="font-semibold text-xl text-white leading-tight flex items-center space-x-2">
            ...
            <div class="flex justify-end">
                <a href="{{ route('admin.drivers.create') }}" class="inline-block bg-green-600 dark:bg-green-700 text-white px-4 py-2 font-bold hover:bg-green-800 dark:hover:bg-green-900">Create</a>
            </div>
