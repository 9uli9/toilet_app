                ...
                <div class="bg-green-600 dark:bg-green-600 rounded-lg shadow-sm">
                    <div class="p-6">
                        ...
                        <form enctype="multipart/form-data" action="{{ route('user.toilets.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                <label for="WKT" class="font-bold">Enter A POINT With Latitude And Longitude</label>
                                <input type="text" name="WKT" id="WKT" placeholder="POINT (-6.263287000000001 53.343151)" class="w-full px-4 py-2 border rounded-md focus:border-green-500" style="color: black;">
                                @error('WKT')
                                    <span class="text-white-500">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="type" id="type" class="w-full px-4 py-2 border rounded-md focus:border-green-500" style="color: black;">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="opening_hours" id="opening_hours" placeholder="Enter Opening Hours" class="w-full px-4 py-2 border rounded-md focus:border-green-500" style="color: black;">
                                @error('opening_hours')
                                    <span class="text-white-500">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                <label for="toilet_image" class="font-bold">Choose A Cover Image For The Toilet:</label>
