    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white leading-tight flex items-center space-x-2">
            ...
            <span class="icon-padding">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" class="w-6 h-6 ml-2"
            ...
            <td class="px-6 py-4 font-medium text-red-900 whitespace-nowrap dark:text-white">
                <a href="{{ route('user.toilets.index', $toilet->id) }}"
                    class="inline-block bg-yellow-500 dark:bg-yellow-600 text-white px-4 py-2 font-bold hover:bg-yellow-600 dark:hover:bg-yellow-700">Back</a>
            </td>
        </h2>
    </x-slot>
        ...
        <div class="py-12 bg-black dark:bg-red-800">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="m-2 flex bg-red-600 dark:bg-red-700 overflow-hidden shadow-sm p-4">
                    ...
                    @endif
                    <div class="ml-4">
                        <h2 class="text-white text-2xl font-bold mb-2">{{ $toilet->first_name }} {{ $toilet->last_name }}</h2>
