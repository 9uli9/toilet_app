            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    ...
                    <div class="ml-4">
                        <div class="py-6">
                            ...
                            <a href="{{ route('user.reviews.create', $toilet->id) }}"
                                class="inline-block bg-orange-500 dark:bg-orange-600 text-white px-4 py-2 font-bold hover:bg-orange-600 dark:hover:bg-orange-700">Write
                                A Review</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-green-600 dark:bg-green-600 rounded-lg shadow-sm">
                    ...
                    <div class="flex justify-center pb-4">
                        <a href="{{ route('user.toilets.edit', $toilet->id) }}"
